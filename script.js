$(document).ready(function () {
     ...
     */
    var content = [{
        title: "Del di baca ya",
        desc: ""
    }, {
        title: "",
        desc: "Semakin kamu ikhlas, maka kamu akan semakin tenang. Belajarlah untuk berlapang dada, karena tidak semua yang kita inginkan itu yang terbaik menurut ALLAH, ajari hatimu untuk selalu menerima semua keadaan"
    }, {
       title: "",
       desc: "Semangat untuk perempuan hebat yang sedang di fase mencoba berdamai dengan keadaan, rasa sedih, kecewa dan mencoba berdamai dengan diri sendiri. pasti berat ya ? gapapa, yang kemarin aja bisa kok . gapapa kalau pengen nangis, tapi bangkit lagi ya jangan menyerah"
    }, {
        title: "",
        desc: "Jika di tengah perjalaan tujuanmu berubah, tidak ada salahnya untuk berputar arah, lebih baik memulai kembali dari awal daripada tiba di tujuan yang salah"
    }, {
        title: "Semangat terus Dela Astria Budiarti",
        desc: "Mana senyumnya :)"
 }];
    var currentPage = 0;
    //generate content
